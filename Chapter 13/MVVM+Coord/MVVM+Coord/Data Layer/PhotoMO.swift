...
final class PhotoMO: NSManagedObject {
    typealias DomainObject = PhotoModel.Photo
...
extension PhotoMO: ConvertToDomainProto {
    func convertToDomain() -> PhotoModel.Photo {
        PhotoModel.Photo(
            albumID: albumId,
            id: id,
            title: title,
...
struct PhotoProperties: Codable, ManagedObjectPropertiesProto, ConvertToDomainProto {
    typealias DomainObject = PhotoModel.Photo
